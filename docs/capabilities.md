...
## 18
* `config => chat => has-translation-providers` - When true, translation tuples can be loaded from the [OCS Translation API](https://docs.nextcloud.com/server/27/developer_manual/client_apis/OCS/ocs-translation-api.html#get-available-translation-options).
