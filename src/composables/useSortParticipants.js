...
export function useSortParticipants() {
	...
	function sortParticipants(participant1, participant2) {
		...
		const p1HandRaised = signalingStateStore.getParticipantRaisedHand(participant1.sessionIds)
		const p2HandRaised = signalingStateStore.getParticipantRaisedHand(participant2.sessionIds)
