...
export default {
	...
	computed: {
		...
		isHandRaised() {
			...
			const raisedState = this.signalingStateStore.getParticipantRaisedHand(this.participant.sessionIds)
		...
		participantSpeakingInformation() {
			return this.signalingStateStore.getParticipantSpeakingInformation(this.attendeeId)
		},
